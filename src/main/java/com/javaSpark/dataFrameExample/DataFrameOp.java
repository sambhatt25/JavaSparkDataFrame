...
public class DataFrameOp {
 ...
 public static Dataset<Row> createDataFrame(SparkSession spark,String csvPath) throws AnalysisException {
            /*
 ...
 public static Dataset<Row> findSalesAndBroadcastRights(Dataset<Row> whatsonDF, Dataset<Row> startedStreamsDF) throws AnalysisException {
         ...
         */
		 ...
		 return broadcastRightsDF;
 }

 public static Dataset<Row> findProductAndUserCount(Dataset<Row> startedStreamsDF) throws AnalysisException {
		 ...
		 return UserCountDF.join(ProductAndUserCountDF,"program_title").select("dt","program_title","device_name","country_code","product_type","unique_users","content_count"); 
 }

 public static Dataset<Row> findGenreAndTimeOfDay(Dataset<Row> startedStreamsDF) throws AnalysisException {
        ...
        return GenreUniqUserDF.join(GenreHourDF,"genre")
	                .select("watched_hour","genre","unique_users").sort(desc("unique_users"));
 ...
 public static void main(String[] args) throws AnalysisException {
        ...
        findSalesAndBroadcastRights(whatsonDF,streamsDF).show(100,false);
        
        System.out.println( "2.	Product and user count results======================================>" );
        findProductAndUserCount(streamsDF).show(100,false);

        System.out.println( "3.	Genre and time of day results======================================>" );
        findGenreAndTimeOfDay(streamsDF).show();
